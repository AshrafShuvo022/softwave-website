    ...
    <div className="bg-[#faf4f1] dark:bg-[#0d0d0d]">
      ...
      <section className="py-24 bg-[#f5f0ec] dark:bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-[#1a1a1a] dark:text-[#faf4f1] mb-4">Ready to Work Together?</h2>
          <p className="text-[#4b5563] dark:text-[#9ca3af] text-lg mb-8">Let&apos;s discuss what we can build for you.</p>
          <Link
            href="/contact"
