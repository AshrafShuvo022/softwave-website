        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center py-16 px-8 rounded-2xl bg-white dark:bg-[#1a1a1a] border border-[#e8735f]/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-[#1a1a1a] dark:text-[#faf4f1] mb-2">Name *</label>
                      <input
                        type="text"
                        required
                        value={form.name}
                        onChange={(e) => setForm({ ...form, name: e.target.value })}
                        className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1a1a1a] border border-[#e5ddd8] dark:border-[#3d3d3d]/50 text-[#1a1a1a] dark:text-[#faf4f1] placeholder:text-[#6b7280] focus:outline-none focus:border-[#e8735f]/50 transition-colors"
                        placeholder="Your name"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[#1a1a1a] dark:text-[#faf4f1] mb-2">Email *</label>
                      <input
                        type="email"
                        required
                        value={form.email}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#1a1a1a] dark:text-[#faf4f1] mb-2">Service Interest</label>
                      <select
                        value={form.service}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1a1a1a] border border-[#e5ddd8] dark:border-[#3d3d3d]/50 text-[#1a1a1a] dark:text-[#faf4f1] placeholder:text-[#6b7280] focus:outline-none focus:border-[#e8735f]/50 transition-colors resize-none"
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-[#1a1a1a] border border-[#e5ddd8] dark:border-[#3d3d3d]/50">
                <h3 className="text-[#1a1a1a] dark:text-[#faf4f1] font-bold mb-4">Connect With Us</h3>
                <div className="flex gap-4">
                  <a
                    href="https://linkedin.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-[#4b5563] dark:text-[#9ca3af] hover:text-[#e8735f] transition-colors text-sm"
                  >
