    ...
    <div className="bg-[#0d0d0d]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={stat.label} className="p-6 rounded-2xl bg-[#1a1a1a] border border-[#3d3d3d]/50 text-center">
      ...
      <section className="py-24 bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-[#0d0d0d] border border-[#3d3d3d]/50">
              <div className="w-12 h-12 rounded-xl bg-[#e8735f]/10 flex items-center justify-center mb-6">
                <Heart className="w-6 h-6 text-[#e8735f]" />
              </div>
              <h3 className="text-2xl font-bold text-[#faf4f1] mb-4">Our Mission</h3>
            ...
            <div className="p-8 rounded-2xl bg-[#0d0d0d] border border-[#3d3d3d]/50">
              ...
              <h3 className="text-2xl font-bold text-[#faf4f1] mb-4">Our Vision</h3>
              <p className="text-[#9ca3af] leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((value) => {
              ...
              return (
                <div key={value.title} className="p-6 rounded-2xl bg-[#1a1a1a] border border-[#3d3d3d]/50 hover:border-[#e8735f]/30 transition-colors group">
                  ...
                  <h3 className="text-lg font-bold text-[#faf4f1] mb-2">{value.title}</h3>
      ...
      <section className="py-24 bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-[#faf4f1] mb-4">Ready to Work Together?</h2>
          <p className="text-[#9ca3af] text-lg mb-8">Let&apos;s discuss what we can build for you.</p>
          <Link
            href="/contact"
